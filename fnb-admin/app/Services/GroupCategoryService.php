...
class GroupCategoryService
{
    ...
    public function getListGroupCategoryService($request)
    {
        try {
            $response = $this->sendRequestToService(
                'get',
                "{$this->baseUrl}/api/group_category_service/getListGroupCategory",
                $request,
            );
    ...
    public function getDetail($request = []){
        try {
            $response = $this->sendRequestToService(
                'get',
                "{$this->baseUrl}/api/group_category_service/getDetail",
                $request,
            );
            if (!$response->successful()) {
                return response()->json([
    ...
    public function detail($request){
        try {
            $response = $this->sendRequestToService(
                'POST',
                "{$this->baseUrl}/api/group_category_service/detail",
                $request,
                [
                    'has_file' => true
                ]
    ...
    public function delete($request){
        try {
            $response = $this->sendRequestToService(
                'POST',
                "{$this->baseUrl}/api/group_category_service/delete",
                $request,
            );
            $data = $response->json();
            return response()->json([
    ...
    public function active($request){
        try {
            $response = $this->sendRequestToService(
                'POST',
                "{$this->baseUrl}/api/group_category_service/active",
                $request,
            );
            $data = $response->json();
            return response()->json([
    ...
    public function getListData($request)
    {
        try {
            $response = $this->sendRequestToService(
                'get',
                "{$this->baseUrl}/api/group_category_service/getListData",
                $request,
            );
            if (!$response->successful()) {
                return response()->json([

...
class PaymentService
{
    ...
    public function getList($request)
    {
        try {
            $response = $this->sendRequestToService(
                'get',
                "{$this->baseUrl}/api/payment/getList",
                $request,
            );
    ...
    public function getDetail($request = []){
        try {
            $response = $this->sendRequestToService(
                'get',
                "{$this->baseUrl}/api/payment/getDetail",
                $request,
            );
            if (!$response->successful()) {
                return response()->json([
    ...
    public function changeStatus($request){
        try {
            $response = $this->sendRequestToService(
                'POST',
                "{$this->baseUrl}/api/payment/changeStatus",
                $request
            );
            $data = $response->json();
            return response()->json([
    ...
    public function delete($request){
        try {
            $response = $this->sendRequestToService(
                'POST',
                "{$this->baseUrl}/api/payment/delete",
                $request,
            );
            $data = $response->json();
            return response()->json([
    ...
    public function getListData($request)
    {
        try {
            $response = $this->sendRequestToService(
                'get',
                "{$this->baseUrl}/api/payment/getListData",
                $request,
            );
            if (!$response->successful()) {
                return response()->json([
    ...
    public function getListDetail($request)
    {
        try {
            $response = $this->sendRequestToService(
                'get',
                "{$this->baseUrl}/api/payment/getListDataDetail/{$request->id}",
                $request,
            );
            if (!$response->successful()) {
                return response()->json([

...
function loadImage($src = null, $size = '50px', $type = 'img-circle', $value = '', $delete = false,$image_old = "image_old", $height = '')
{
...
function get_user_token($staff_id = 0)
{
    if (!empty($staff_id)) {
        $user = Cache::remember('user-info', 3600, function () use ($staff_id){
            return \App\Models\User::find($staff_id);
            ...
            [
                ...
                'child' => [
                    [
                        ...
                        'name' => lang('Nhóm danh mục dịch vụ'),
                        'link' => 'admin/group_category_service/list',
                        'image' => '',
                    ],
                    [
                        'id' => 'category_service',
                        'name' => lang('Danh mục dịch vụ'),
                        'link' => 'admin/category_service/list',
                        'image' => '',
                    ],
                    [
                        'id' => 'other_amenities_service',
                        'name' => lang('Tiện nghi'),
...
{
    return ' <table id="table_service" class="table table-bordered table_service">
            <thead>
            <tr>

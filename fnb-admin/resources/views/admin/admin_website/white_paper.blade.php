...
@section('content')
    ...
    <div class="row">
        <form id="HomepageForm" action="admin/admin_website/submit_white_paper" method="post" data-parsley-validate
              novalidate

        ...
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15">
                <a type="button" class="btn btn-default dropdown-toggle waves-effect waves-light dt-modal" data-toggle="dropdown"
                   aria-expanded="false" href="admin/department/detail">{{lang('dt_create')}}</a>
            </div>
            <h4 class="page-title text-capitalize">{{lang('dt_department')}}</h4>
            <ol class="breadcrumb">
                <li><a href="admin/dashboard">{{lang('dt_index')}}</a></li>
                <li><a href="admin/department/list">{{lang('dt_department')}}</a></li>
    ...
    <script>
        ...
        oTable = InitDataTable('#table_department', 'admin/department/getDepartment', {
            ...
            columnDefs: [
                ...
                {data: 'code', name: 'code'},
                {data: 'name', name: 'name'},
                {data: 'check_transaction', name: 'check_transaction',width: "100px",
                    "render": function (data, type, row) {
                        return `<div class="text-center">${data}</data>`;
                    },
                },

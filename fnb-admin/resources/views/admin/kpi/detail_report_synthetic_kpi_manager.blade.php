    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                ...
                <div class="col-md-12 view-table-synthetic-kpi-manager" style="padding: 1px; margin-top: 10px">
...
@section('script')
    <script>
        function loadSyntheticKpiManager() {
            ...
            if (month_search && year_search) {
                $.ajax({
                    type: "GET",
                    url: 'admin/kpi/load_add_report_synthetic_kpi_manager',
                    data: {
                    ...
                    success: function (response) {
                        if (response) {
                            $('.view-table-synthetic-kpi-manager').html(response);
                        }
                    }
                });
            }
        }
        loadSyntheticKpiManager();

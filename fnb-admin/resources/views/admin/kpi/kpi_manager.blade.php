...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="page-title text-capitalize">{{lang('KPI giám đốc kinh doanh')}}</h4>
            <ol class="breadcrumb">
                <li><a href="admin/dashboard">{{lang('dt_index')}}</a></li>
                <li><a href="admin/kpi/kpi_manager">{{lang('KPI giám đốc kinh doanh')}}</a></li>
        ...
        <div class="col-sm-12">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="info">
                    <div class="card-box">
                        <form action="admin/kpi/submitKPIManager" method="post" id="formKpiManager"
                                        ...
                                        <div class="section">
                                            ...
                                            <div class="subsection">
                                                ...
                                                <p style="margin-bottom: 15px;"><strong>Doanh số mục tiêu:</strong>
                                                    ...
                                                    VNĐ/tháng/xã <span style="font-weight: bold">( Số lượng xã tùy theo từng giám đốc: 5,10,30,40..)</span>
                                                </p>
                    ...
                    <div>
                        <div class="subsection">
                            <div class="criteria-list">
                                <div class="criteria-item">
                                    <div class="check-icon"></div>
                                    <span>Công thức tính sẽ được tính bằng cách tạo mới trực tiếp trên phầm mềm vào mỗi cuối tháng (KPI -> Thống kê KPI giám đốc kinh doanh -> tạo mới)</span>
                                </div>
                                <div class="criteria-item">
                                    <div class="check-icon"></div>
                                    <span>Trên mỗi nhân viên có check để biết nhân viên đó là GDKD (Nhân viên -> GDKD KPI)</span>
                                </div>
                                <div class="criteria-item">
                                    <div class="check-icon"></div>
                                    <span>Chủ động theo dõi được KPI hiện tại của giám đốc kinh doanh theo những tiêu chí</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="criteria-list">
                                        <div class="criteria-item">
                                            <div class="check-icon"></div>
                                            <span>Điều kiện lấy sẽ như sau. Trên mỗi đối tác có gắn nhân viên phụ trách và lấy thêm điều kiện những nhân viên thuộc cấp dưới của giám đốc kinh doanh dựa vào (phòng ban, khu vực kinh danh để lấy nhân viên cấp dưới)
                                        dựa vào đó sẽ lấy tổng thu nhập trên tất cả các phiếu thu đã thanh toán của đối tác trên từng tháng (Giao dịch -> Phiếu thu)</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="criteria-list">
                                        <div class="criteria-item">
                                            <div class="check-icon"></div>
                                            <span>Số lượng xã sẽ được tính dựa vào khu vực kinh doanh của giám đốc kinh doanh để tính ra được số lượng xã quản lý</span>
                                        </div>
                                    </div>
                                    <div class="criteria-list">
                                        <div class="criteria-item">
                                    ...
                                    <div class="criteria-list">
                                        <div class="criteria-item">
                                            <div class="check-icon"></div>
                                            <span>Điều kiện lấy sẽ như sau. Trên mỗi đối tác có gắn nhân viên phụ trách và lấy thêm điều kiện những nhân viên thuộc cấp dưới của giám đốc kinh doanh dựa vào (phòng ban, khu vực kinh danh để lấy nhân viên cấp dưới) dựa vào đó sẽ lấy những gian hàng nào đăng ký mới ( đã duyệt) của đối tác mình quản lý trên từng tháng (Đối tác -> Danh sách gian hàng)</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="criteria-list">
                                        <div class="criteria-item">
                                            <div class="check-icon"></div>
                                            <span>Điều kiện lấy sẽ như sau. Trên mỗi đối tác, thành viên có gắn nhân viên phụ trách và lấy thêm điều kiện những nhân viên thuộc cấp dưới của giám đốc kinh doanh dựa vào (phòng ban, khu vực kinh danh để lấy nhân viên cấp dưới) dựa vào đó sẽ thống kê ra những thành viên, đối tác nào còn hạn sử dụng phần mềm để thống kê trên từng tháng (Dựa vào ngày hết hạn sử dụng ngay thời điểm tạo tính KPI)</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="criteria-list">
                                        <div class="criteria-item">
                                            <div class="check-icon"></div>
                                            <span>Điều kiện lấy sẽ như sau. Dựa vào phiếu vi phạm được lập trên phầm mềm của mỗi nhân viên giám đốc kinh doanh (KPI -> Phiếu vi pham)</span>
                                        </div>
                                    </div>
                ...
                $.ajax({
                    ...
                    .done(function (data) {
                        if (data.result) {
                            ...
                            window.location.href = 'admin/kpi/kpi_manager';
                        } else {

...
<div class="container-fluid" style="padding-left: unset !important;padding-right: unset !important;">
    <section id="loading">
        <img class="loading_img hide" src="admin/assets/images/loading.gif"/>
        <div id="loading-content"></div>
    </section>
    <div id="toast-container-new" class="toast-top-right-new"></div>
    <!-- content -->

        @yield('content_not_header')
        <div class="modal fade" id="dtModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"></div>
        <div class="modal fade" style="z-index: 999999999999" id="dtModal2" tabindex="-1" role="dialog"
...
<script src="admin/assets/js/app.js?v=1.0"></script>

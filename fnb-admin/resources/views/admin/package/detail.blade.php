                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="type select2" name="type" >
                                @foreach(getListTypePackage() as $key => $val)
                                    <option value="{{$val['id']}}" {{!empty($dtData) && $dtData['type'] == $val['id'] ? 'selected' : ''}}>{{$val['name']}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control note editor" name="note" cols="2" rows="2">{{!empty($dtData) ? $dtData['note'] : ''}}</textarea>
                        </div>
                    </div>
                </div>
            </div>

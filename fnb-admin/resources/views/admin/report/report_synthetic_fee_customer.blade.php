    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="admin/report/report_synthetic_fee_customer">{{$title}}</a></li>
        ...
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <div class="row m-b-10">
                    <div class="col-md-3">
                        <input type="hidden" id="type_client" value="1">
                ...
                <table id="table_report_synthetic_fee_customer" class="table table-bordered table_report_synthetic_fee_customer">
                    <thead>
                    <tr>
                        <th class="text-center">{{lang('dt_stt')}}</th>
                        <th class="text-center">{{lang('Khu vực kinh doanh')}}</th>
                        <th class="text-center">{{lang('Tổng số thành viên')}}</th>
...
@section('script')
    ...
    <script>
        ...
        var oTable;
        oTable = InitDataTable('#table_report_synthetic_fee_customer', 'admin/report/getListSyntheticFeeCustomer', {
            'order': [
                [0, 'asc']
            ],
            'responsive': true,
            "ajax": {
                "type": "POST",
                "url": "admin/report/getListSyntheticFeeCustomer",
                "data": function (d) {
        ...
        $('#table_report_synthetic_fee_customer').on('draw.dt', function () {
            var table = $(this).DataTable();
            var total_partner =  table.column(2).data().sum();
            var total_fee =  table.column(3).data().sum();
            $("#table_report_synthetic_fee_customer").find('tfoot .total_partner').html(formatNumber(total_partner));
            $("#table_report_synthetic_fee_customer").find('tfoot .total_fee').html(formatMoney(total_fee));
        });
        var table = $('#table_report_synthetic_fee_customer').DataTable();
        ...
        $('#exportButton').click(function() {
            ...
            $('#table_report_synthetic_fee_customer thead tr th').each(function() {
            ...
            table.rows().every(function(rowIdx, tableLoop, rowLoop) {
                ...
                $('#table_report_synthetic_fee_customer thead tr th').each(function(index) {
            ...
            XLSX.writeFile(wb, "thong_ke_thu_phi_dich_vu_thanh_vien.xlsx");
        });
    </script>
@endsection

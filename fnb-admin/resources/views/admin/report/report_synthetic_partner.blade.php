    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="admin/report/report_synthetic_partner">{{$title}}</a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                ...
                <table id="table_report_synthetic_partner" class="table table-bordered table_report_synthetic_partner">
                    <thead>
                    <tr>
                        ...
                        <th class="text-center">{{lang('Doanh thu')}}</th>
                        <th class="text-center">{{lang('Hoa hồng dự kiến chi')}}</th>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td class="total_payment" style="font-weight: bold;text-align: right"></td>
                        <td class="total_rose" style="font-weight: bold;text-align: right"></td>
                        <td></td>
                    </tr>
                    </tfoot>
                </table>
...
@section('script')
    ...
    <script>
        ...
        var oTable;
        oTable = InitDataTable('#table_report_synthetic_partner', 'admin/report/getListSyntheticRevenuePartner', {
            'order': [
                [0, 'asc']
            ],
            'responsive': true,
            "ajax": {
                "type": "POST",
                "url": "admin/report/getListSyntheticRevenuePartner",
                "data": function (d) {
            ...
            columnDefs: [
                ...
                {data: 'service', name: 'service',width: "250px", orderable: false },
                ...
                },
                {
                    ...
                    data: 'total_rose', name: 'total_rose',width: "120px", orderable: false
                },
        ...
        $('#table_report_synthetic_partner').on('draw.dt', function () {
            var table = $(this).DataTable();
            var total_payment =  table.column(7).data().sum();
            var total_rose =  table.column(8).data().sum();
            $("#table_report_synthetic_partner").find('tfoot .total_payment').html(formatNumber(total_payment));
            $("#table_report_synthetic_partner").find('tfoot .total_rose').html(formatNumber(total_rose));
        });

        var table = $('#table_report_synthetic_partner').DataTable();
        ...
        $('#exportButton').click(function() {
            ...
            $('#table_report_synthetic_partner thead tr th').each(function() {
            ...
            table.rows().every(function(rowIdx, tableLoop, rowLoop) {
                ...
                $('#table_report_synthetic_partner thead tr th').each(function(index) {
                    ...
                    if (cellText) {
                        ...
                        rowData.push(table.cell(rowIdx, index).data()); // Nếu không có thẻ <a> và <div>, lấy dữ liệu gốc
                    }
                });
            ...
            XLSX.writeFile(wb, "bao_cao_doanh_thu_doi_tac.xlsx");
        });
    </script>
@endsection

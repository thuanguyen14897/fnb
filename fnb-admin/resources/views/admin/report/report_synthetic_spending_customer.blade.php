    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="admin/report/report_synthetic_spending_customer">{{$title}}</a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                ...
                <table id="table_report_synthetic_spending_customer" class="table table-bordered table_report_synthetic_spending_customer">
                    <thead>
                    <tr>
...
@section('script')
    ...
    <script>
        $(document).ready(function (){
            ...
            searchAjaxSelect2('#customer_search','admin/category/searchCustomer',0)
        ...
        var oTable;
        oTable = InitDataTable('#table_report_synthetic_spending_customer', 'admin/report/getListSyntheticSpendingCustomer', {
            'order': [
                [0, 'asc']
            ],
            'responsive': true,
            "ajax": {
                "type": "POST",
                "url": "admin/report/getListSyntheticSpendingCustomer",
                "data": function (d) {
        ...
        $('#table_report_synthetic_spending_customer').on('draw.dt', function () {
            var table = $(this).DataTable();
            var total_payment =  table.column(8).data().sum();
            $("#table_report_synthetic_spending_customer").find('tfoot .total_payment').html(formatNumber(total_payment));
        });
        var table = $('#table_report_synthetic_spending_customer').DataTable();
        ...
        $('#exportButton').click(function() {
            ...
            $('#table_report_synthetic_spending_customer thead tr th').each(function() {
            ...
            table.rows().every(function(rowIdx, tableLoop, rowLoop) {
                ...
                $('#table_report_synthetic_spending_customer thead tr th').each(function(index) {
            ...
            XLSX.writeFile(wb, "thong_ke_doanh_thu_chi_tieu_thanh_vien.xlsx");
        });
    </script>
@endsection

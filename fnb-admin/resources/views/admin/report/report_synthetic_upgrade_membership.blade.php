    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="admin/report/report_synthetic_upgrade_membership">{{$title}}</a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                ...
                <table id="table_report_synthetic_upgrade_membership" class="table table-bordered table_report_synthetic_upgrade_membership">
                    <thead>
                    <tr>
                        ...
                        <th class="text-center">{{lang('Ngày nâng hạng')}}</th>
...
@section('script')
    ...
    <script>
        ...
        var oTable;
        oTable = InitDataTable('#table_report_synthetic_upgrade_membership', 'admin/report/getListSyntheticUpgradeMembership', {
            'order': [
                [0, 'asc']
            ],
            'responsive': true,
            "ajax": {
                "type": "POST",
                "url": "admin/report/getListSyntheticUpgradeMembership",
                "data": function (d) {
            ...
            columnDefs: [
                ...
                {data: 'member_ship', name: 'member_ship',width: "150px",orderable: false },
                {data: 'phone', name: 'phone',width: "100px", orderable: false },
                {data: 'email', name: 'email',width: "120px", orderable: false },
                {data: 'ranking_date', name: 'ranking_date',width: "120px", orderable: false },
        ...
        var table = $('#table_report_synthetic_upgrade_membership').DataTable();
        ...
        $('#exportButton').click(function() {
            ...
            $('#table_report_synthetic_upgrade_membership thead tr th').each(function() {
            ...
            table.rows().every(function(rowIdx, tableLoop, rowLoop) {
                ...
                $('#table_report_synthetic_upgrade_membership thead tr th').each(function(index) {
            ...
            XLSX.writeFile(wb, "bao_cao_nang_hang_thanh_vien_vuot_cap.xlsx");
        });
    </script>
@endsection

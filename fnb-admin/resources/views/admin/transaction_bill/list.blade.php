    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="admin/transaction_bill/list">{{$title}}</a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card-box table-responsive">
                ...
                <table id="table_transaction_bill" class="table table-bordered table_transaction_bill">
                    <thead>
                    <tr>
                        ...
                        <th class="text-center">{{lang('Chuyến đi')}}</th>
                        ...
                        <th class="text-center">{{lang('Tổng tiền giảm')}}</th>
...
@section('script')
    <script>
        ...
        var oTable;
        oTable = InitDataTable('#table_transaction_bill', 'admin/transaction_bill/getList', {
            'order': [
                [0, 'desc']
            ],
            'responsive': true,
            "ajax": {
                "type": "POST",
                "url": "admin/transaction_bill/getList",
                "data": function (d) {
            ...
            columnDefs: [
                ...
                {data: 'reference_no', name: 'reference_no',width: "90px" },
                {data: 'date', name: 'date',width: "100px" },
                {data: 'customer', name: 'customer',width: "140px",orderable: false},
                {data: 'transaction', name: 'transaction'},
                {data: 'service', name: 'service'},
                {data: 'partner', name: 'partner',width: "140px",orderable: false},
                {
                    "render": function (data, type, row) {
                        return `<div class="text-center">${data}</data>`;
                    },
        ...
        function getCountAll() {
            ...
            $.ajax({
                url: 'admin/transaction_bill/countAll',
                type: 'POST',
                dataType: 'JSON',
                cache: false,
                data: data

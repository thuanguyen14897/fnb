...
class ServiceController extends AuthController
{
    ...
    public function detail(){
        ...
        DB::beginTransaction();
        try {
            $created_by = !empty($this->request->user) ? $this->request->user->id : $this->request->client->id;
            ...
            $dtData->customer_id = $this->request->input('customer_id');
            ...
            if ($dtData) {
                ...
                if ($this->request->hasFile('image_store')) {
                    if (is_array($this->request->file('image_store'))) {
                        foreach ($this->request->file('image_store') as $file) {
